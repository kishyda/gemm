...
__global__ void gemm_08(size_t m, size_t n, size_t k, T alpha,
                                    ...
                                    size_t ldb, T beta, T* C, size_t ldc)
{
    ...
    nvcuda::wmma::fragment<nvcuda::wmma::matrix_a, WMMA_TILE_SIZE_Y,
                        WMMA_TILE_SIZE_K, WMMA_TILE_SIZE_K, __half,
                        nvcuda::wmma::col_major>
        a_frags[NUM_WMMA_TILES_Y];
    nvcuda::wmma::fragment<nvcuda::wmma::matrix_b, WMMA_TILE_SIZE_K,
                        WMMA_TILE_SIZE_X, WMMA_TILE_SIZE_K, __half,
                        nvcuda::wmma::row_major>
        b_frags[NUM_WMMA_TILES_X];
    nvcuda::wmma::fragment<nvcuda::wmma::accumulator, WMMA_TILE_SIZE_Y,
                        WMMA_TILE_SIZE_X, WMMA_TILE_SIZE_K, float>
...
template <typename T>
void launch_gemm_08(size_t m, size_t n, size_t k,
                                       ...
                                       T* C, size_t ldc)
{
    ...
    dim3 const grid_dim{
        ...
        (static_cast<unsigned int>(m) + BLOCK_TILE_SIZE_Y - 1U) /
            BLOCK_TILE_SIZE_Y,
        1U};
    gemm_08<T, BLOCK_TILE_SIZE_X, BLOCK_TILE_SIZE_Y,
...
NB_MODULE(gemm_08, m) {
    m.def("launch_gemm_float", &launch_gemm_08<float>, "m"_a, "n"_a, "k"_a, "alpha"_a, "A"_a, "lda"_a, "B"_a, "ldb"_a, "beta"_a, "C"_a, "ldc"_a);
    ...
    //     launch_gemm_kernel_v07_vectorized<float>(m, n, k, alpha, A, lda, B, ldb, beta, C, ldc);
